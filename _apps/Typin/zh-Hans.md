...
<div class="feature-category">
    ...
    <div class="features-grid">
        <div class="feature-card">
            ...
            <h3>双模式编辑</h3>
            <p>一键切换纯文本和 Markdown 实时渲染模式。应用会记住您偏好的编辑模式。</p>
        </div>
        <div class="feature-card">
            <div class="feature-icon">
            ...
            <h3>丰富的 Markdown 支持</h3>
            <p>完整支持标题、粗体、斜体、行内代码、列表和引用，配有自定义语法高亮和实时渲染。</p>
        </div>
        <div class="feature-card">
            <div class="feature-icon">
            ...
            <h3>智能符号插入</h3>
            <p>快速插入常用 Markdown 符号，不打断您的写作思路。块级符号插入行首，内联符号插入光标位置。</p>
        </div>
        <div class="feature-card">
            <div class="feature-icon">
            ...
            <h3>文本操作</h3>
            <p>复制当前行、全选、粘贴、替换行或清空文档，手势操作直观便捷。智能复制根据焦点状态自适应。</p>
        </div>
    </div>
</div>
...
<div class="feature-category">
    ...
    <div class="features-grid">
        <div class="feature-card">
            ...
            <h3>文档管理</h3>
            <p>轻松创建、重命名、删除、置顶和分享文档。重复标题检测确保文档井井有条。</p>
        </div>
        <div class="feature-card">
            <div class="feature-icon">
            ...
            <h3>多文档支持</h3>
            <p>使用便捷的文件抽屉同时处理多个文档。应用会记住您最后打开的文档。</p>
        </div>
        <div class="feature-card">
            <div class="feature-icon">
            ...
            <h3>自动保存</h3>
            <p>可配置的自动保存间隔（10秒、30秒、60秒、120秒），再也不会丢失工作内容。应用进入后台时自动保存。</p>
        </div>
    </div>
</div>
...
<div class="feature-category">
    ...
    <div class="features-grid">
        <div class="feature-card">
            ...
            <h3>多语言支持</h3>
            <p>支持 7 种语言：英语、简体中文、繁体中文、日语、韩语、法语和德语。即时切换，无需重启应用。</p>
        </div>
        <div class="feature-card">
            <div class="feature-icon">
            ...
            <h3>主题支持</h3>
            <p>选择浅色、深色或跟随系统主题。动态颜色自适应，过渡流畅，实时更新。</p>
        </div>
        <div class="feature-card">
            <div class="feature-icon">
            ...
            <h3>触觉反馈与动画</h3>
            <p>享受流畅的动画和灵敏的触觉反馈。每一次交互都有触觉反馈增强体验。</p>
        </div>
        <div class="feature-card">
            <div class="feature-icon">
            ...
            <h3>键盘管理</h3>
            <p>智能键盘处理，工具栏动态定位。工具栏悬浮于键盘上方，快速访问 Markdown 符号。</p>
        </div>
    </div>
</div>
