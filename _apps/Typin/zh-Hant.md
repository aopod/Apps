...
<div class="feature-category">
    ...
    <div class="features-grid">
        <div class="feature-card">
            ...
            <h3>雙模式編輯</h3>
            <p>一鍵切換純文字和 Markdown 即時渲染模式。應用會記住您偏好的編輯模式。</p>
        </div>
        <div class="feature-card">
            <div class="feature-icon">
            ...
            <h3>豐富的 Markdown 支援</h3>
            <p>完整支援標題、粗體、斜體、行內程式碼、列表和引用，配備自訂語法高亮和即時渲染。</p>
        </div>
        <div class="feature-card">
            <div class="feature-icon">
            ...
            <h3>智慧符號插入</h3>
            <p>快速插入常用 Markdown 符號，不打斷您的寫作思路。區塊符號插入行首，行內符號插入游標位置。</p>
        </div>
        <div class="feature-card">
            <div class="feature-icon">
            ...
            <h3>文字操作</h3>
            <p>複製目前行、全選、貼上、替換行或清空文件，手勢操作直觀便捷。智慧複製根據焦點狀態自適應。</p>
        </div>
    </div>
</div>
...
<div class="feature-category">
    ...
    <div class="features-grid">
        <div class="feature-card">
            ...
            <h3>文件管理</h3>
            <p>輕鬆建立、重新命名、刪除、置頂和分享文件。重複標題檢測確保文件井然有序。</p>
        </div>
        <div class="feature-card">
            <div class="feature-icon">
            ...
            <h3>多文件支援</h3>
            <p>使用便捷的文件抽屜同時處理多個文件。應用會記住您最後開啟的文件。</p>
        </div>
        <div class="feature-card">
            <div class="feature-icon">
            ...
            <h3>自動儲存</h3>
            <p>可配置的自動儲存間隔（10秒、30秒、60秒、120秒），再也不會遺失工作內容。應用進入背景時自動儲存。</p>
        </div>
    </div>
</div>
...
<div class="feature-category">
    ...
    <div class="features-grid">
        <div class="feature-card">
            ...
            <h3>多語言支援</h3>
            <p>支援 7 種語言：英語、簡體中文、繁體中文、日語、韓語、法語和德語。即時切換，無需重新啟動應用。</p>
        </div>
        <div class="feature-card">
            <div class="feature-icon">
            ...
            <h3>主題支援</h3>
            <p>選擇淺色、深色或跟隨系統主題。動態顏色自適應，過渡流暢，即時更新。</p>
        </div>
        <div class="feature-card">
            <div class="feature-icon">
            ...
            <h3>觸覺回饋與動畫</h3>
            <p>享受流暢的動畫和靈敏的觸覺回饋。每次互動都有觸覺回饋增強體驗。</p>
        </div>
        <div class="feature-card">
            <div class="feature-icon">
            ...
            <h3>鍵盤管理</h3>
            <p>智慧鍵盤處理，工具列動態定位。工具列懸浮於鍵盤上方，快速存取 Markdown 符號。</p>
        </div>
    </div>
</div>
