...
<div class="feature-category">
    ...
    <div class="features-grid">
        <div class="feature-card">
            ...
            <h3>デュアルモード編集</h3>
            <p>ワンタップでプレーンテキストとMarkdownレンダリングを切り替え。好みの編集モードを記憶します。</p>
        </div>
        <div class="feature-card">
            <div class="feature-icon">
            ...
            <h3>リッチMarkdownサポート</h3>
            <p>見出し、太字、斜体、インラインコード、リスト、引用を完全サポート。カスタムシンタックスハイライトとリアルタイムレンダリング。</p>
        </div>
        <div class="feature-card">
            <div class="feature-icon">
            ...
            <h3>スマートシンボル挿入</h3>
            <p>一般的なMarkdown記号を素早く挿入し、執筆のリズムを崩しません。ブロック記号は行頭に、インライン記号はカーソル位置に挿入。</p>
        </div>
        <div class="feature-card">
            <div class="feature-icon">
            ...
            <h3>テキスト操作</h3>
            <p>現在の行のコピー、すべて選択、貼り付け、行の置換、ドキュメントのクリアを直感的なジェスチャーで。フォーカス状態に応じたスマートコピー。</p>
        </div>
    </div>
</div>
...
<div class="feature-category">
    ...
    <div class="features-grid">
        <div class="feature-card">
            ...
            <h3>ドキュメント管理</h3>
            <p>ドキュメントの作成、名前変更、削除、ピン留め、共有を簡単に。重複タイトル検出で整理整頓。</p>
        </div>
        <div class="feature-card">
            <div class="feature-icon">
            ...
            <h3>マルチドキュメント対応</h3>
            <p>便利なファイルドロワーで複数のドキュメントを同時に処理。最後に開いたドキュメントを記憶します。</p>
        </div>
        <div class="feature-card">
            <div class="feature-icon">
            ...
            <h3>自動保存</h3>
            <p>設定可能な自動保存間隔（10秒、30秒、60秒、120秒）で作業を失いません。アプリがバックグラウンドに入ると自動保存。</p>
        </div>
    </div>
</div>
...
<div class="feature-category">
    ...
    <div class="features-grid">
        <div class="feature-card">
            ...
            <h3>多言語対応</h3>
            <p>7つの言語に対応：英語、簡体字中国語、繁体字中国語、日本語、韓国語、フランス語、ドイツ語。再起動なしで即座に切り替え。</p>
        </div>
        <div class="feature-card">
            <div class="feature-icon">
            ...
            <h3>テーマ対応</h3>
            <p>ライト、ダーク、システムテーマから選択。滑らかなトランジションとリアルタイム更新で動的なカラーが適応。</p>
        </div>
        <div class="feature-card">
            <div class="feature-icon">
            ...
            <h3>触覚フィードバックとアニメーション</h3>
            <p>滑らかなアニメーションと反応の良い触覚フィードバックをお楽しみください。すべての操作が触覚でフィードバックされます。</p>
        </div>
        <div class="feature-card">
            <div class="feature-icon">
            ...
            <h3>キーボード管理</h3>
            <p>スマートキーボード処理と動的なツールバー配置。ツールバーはキーボードの上に浮かび、Markdown記号に素早くアクセス。</p>
        </div>
    </div>
</div>
