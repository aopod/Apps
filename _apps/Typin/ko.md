...
<div class="feature-category">
    ...
    <div class="features-grid">
        <div class="feature-card">
            ...
            <h3>이중 모드 편집</h3>
            <p>한 번의 탭으로 일반 텍스트와 Markdown 렌더링 간에 전환합니다. 선호하는 편집 모드를 기억합니다.</p>
        </div>
        <div class="feature-card">
            <div class="feature-icon">
            ...
            <h3>풍부한 Markdown 지원</h3>
            <p>사용자 정의 구문 강조 표시 및 실시간 렌더링으로 제목, 굵게, 기울임꼴, 인라인 코드, 목록, 인용을 완전히 지원합니다.</p>
        </div>
        <div class="feature-card">
            <div class="feature-icon">
            ...
            <h3>스마트 기호 삽입</h3>
            <p>작성 흐름을 방해하지 않고 일반적인 Markdown 기호를 빠르게 삽입합니다. 블록 기호는 줄의 시작 부분에, 인라인 기호는 커서 위치에 삽입됩니다.</p>
        </div>
        <div class="feature-card">
            <div class="feature-icon">
            ...
            <h3>텍스트 작업</h3>
            <p>직관적인 제스처로 현재 줄 복사, 모두 선택, 붙여넣기, 줄 바꾸기 또는 문서 지우기. 포커스 상태에 따라 적응하는 스마트 복사.</p>
        </div>
    </div>
</div>
...
<div class="feature-category">
    ...
    <div class="features-grid">
        <div class="feature-card">
            ...
            <h3>문서 관리</h3>
            <p>문서를 쉽게 만들기, 이름 바꾸기, 삭제, 고정 및 공유하세요. 중복 제목 감지로 깔끔한 정리를 보장합니다.</p>
        </div>
        <div class="feature-card">
            <div class="feature-icon">
            ...
            <h3>다중 문서 지원</h3>
            <p>편리한 파일 서랍을 사용하여 여러 문서를 동시에 처리하세요. 마지막으로 연 문서를 기억합니다.</p>
        </div>
        <div class="feature-card">
            <div class="feature-icon">
            ...
            <h3>자동 저장</h3>
            <p>구성 가능한 자동 저장 간격(10초, 30초, 60초, 120초)으로 작업을 잃지 않습니다. 앱이 백그라운드로 들어갈 때 자동으로 저장됩니다.</p>
        </div>
    </div>
</div>
...
<div class="feature-category">
    ...
    <div class="features-grid">
        <div class="feature-card">
            ...
            <h3>다국어 지원</h3>
            <p>7개 언어 지원: 영어, 간체 중국어, 번체 중국어, 일본어, 한국어, 프랑스어, 독일어. 재시작 없이 즉시 전환.</p>
        </div>
        <div class="feature-card">
            <div class="feature-icon">
            ...
            <h3>테마 지원</h3>
            <p>밝은 모드, 어두운 모드 또는 시스템 테마 중에서 선택하세요. 부드러운 전환과 실시간 업데이트로 동적 색상이 적응합니다.</p>
        </div>
        <div class="feature-card">
            <div class="feature-icon">
            ...
            <h3>터치 피드백 및 애니메이션</h3>
            <p>앱 전체에서 부드러운 애니메이션과 반응성이 좋은 터치 피드백을 즐기세요. 모든 상호작용이 햅틱 피드백으로 향상됩니다.</p>
        </div>
        <div class="feature-card">
            <div class="feature-icon">
            ...
            <h3>키보드 관리</h3>
            <p>스마트 키보드 처리 및 동적 도구 모음 배치. 도구 모음은 키보드 위에 떠 있으며 Markdown 기호에 빠르게 액세스할 수 있습니다.</p>
        </div>
    </div>
</div>
